...
class QueryObject extends CoreObject{

}
class PostObject extends CoreObject{
...
function get_template(){
  return hook( 'get_template' );
}
function set_template( $template ){
  return hook( 'set_template', $template );
}

function get_posts(){
  return hook( 'get_posts' );
}
function has_posts(){
  return hook( 'has_posts' );
}
